...
Movies Library Metadata Explorer using Django. <br>
It includes a REST API for the catalog models using Django REST Framework. <br>
...
* Regarding the TMDB integration:
  ...
  * You will need to get a TMDB API access token to use this integration: <br>
